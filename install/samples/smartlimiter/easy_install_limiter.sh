...
slimeboot_smartlimiter_url="https://raw.githubusercontent.com/slime-io/limiter/$limiter_tag_or_commit/install/samples/smartlimiter/slimeboot_smartlimiter.yaml"
